...
##=============[setting]========================================
keys=["6cd7ce31-00e7-4f4d-9ce2-60af5bcc4bb8"]  ## recommend 2 keys
    ...
    try:
        ...
        if stats["lv"] == -1:
            if formatMode=="msg":
                ...
                mainbody = info[0]+f'-(Nicked?)(No-data)(mode={mode})'
            elif formatMode=="discord":
                mainbody = info[0]+' (Nicked?) (No data)'
        else:
            if formatMode=="msg":
                ...
                mainbody = "{:>4}✫ {:<10}{:<3} {:^6} {:^5} {:^5} {:^6}".format(stats["lv"],info[0][:10],info[1],stats["fkdr"],stats["wr"],stats["ws"],stats["bblr"])
...
if __name__ == "__main__":
    data=getPlayer("_Me","9f9bXXX3-6d32-XXXX-8XX1-59fXXXXf345b")
    print(convert(data,5,formatMode="msg"))
    print(convert(data,5,formatMode="party"))
    # 0=Overall
    # 1-4 = Solo-4S
